...
3. Check the two hand-added rows (H1, H2): does the diff contain the line each cites, and is the
   claim one the table can make without a number? H1 is a hot-path cost and must carry a number
