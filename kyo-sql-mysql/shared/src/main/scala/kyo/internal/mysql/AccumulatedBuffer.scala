...
final class AccumulatedBuffer:
    ...
    def peek(n: Int): Span[Byte] =
        ...
        // Performance: while loop for the span-crossing peek; its mutable state does not escape this method.
        while written < n do
    ...
    def consume(n: Int): Span[Byte] =
        ...
        totalBytes -= n
        var remaining = n
        // Performance: while loop for the span-crossing consume; its mutable state does not escape this method.
